...
# General OpenMandriva patches
#-----------------------------
# OpenMandriva uses pythonegg(M) / python3egg(M) instead of pythonegg(X)(M)
Patch6001:  6001-Use-OpenMandriva-s-variant-of-legacy-pythonegg-depen.patch
